...
local about = UITab2:section("『111』",true)

about:Label("你当前的CFrame"..tostring(game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame or "N/A"))

about:Button("复制你的CFrame", function()
setclipboard(tostring(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame))
end)

local UITab3 = win:Tab("『spy』",'7734068321')

local about = UITab3:section("『GG』",true)

about:Button("ato汉化", function()
...
local UITab4 = win:Tab("『dex』",'7734068321')

local about = UITab4:section("『dex』",true)

about:Button("小云 翻译", function()
loadstring(game:HttpGet("https://github.com/XiaoYunCN/VIP/raw/main/DexV2%20Mobile", true))()
end)

about:Button("dex 我经常用", function()
